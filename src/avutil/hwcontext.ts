...
import { AVBufferPool, AVBuffer } from "./buffer";
import { AVDictionary } from "./dict";
import { AVFrame } from "./frame";
import { AVClass } from "./log";
import { AVPixelFormat } from "./pixfmt";

export enum AVHWDeviceType {
...
export type AVHWDeviceInternal = OpaquePtr;
 ...
 * state.
 */
export interface AVHWDeviceContext {
    /**
     ...
     */
    free: (ctx: AVHWDeviceContext) => void;

    /**
     * Arbitrary user data, to be used e.g. by the free() callback.
     */
    user_opaque: OpaquePtr;
}

export type AVHWFramesInternal = OpaquePtr;
 ...
 * struct.
 */
export interface AVHWFramesContext {
    /**
     * A class for logging.
     */
    av_class: AVClass;
     ...
     * this context is unreferenced, immediately before it is freed.
     */
    free: (ctx: AVHWFramesContext) => void;
 ...
 */
export interface AVHWFramesConstraints {
    /**
 ...
 */
export function av_hwframe_constraints_free(constraints: Ref<AVHWFramesConstraints>): void {};
 ...
 */
export const AV_HWFRAME_MAP_READ      = 1 << 0;
/**
 * The mapping must be writeable.
 */
export const AV_HWFRAME_MAP_WRITE     = 1 << 1;
/**
 * The mapped frame will be overwritten completely in subsequent
 * operations, so the current frame data need not be loaded.  Any values
 * which are not overwritten are unspecified.
 */
export const AV_HWFRAME_MAP_OVERWRITE = 1 << 2;
/**
 * The mapping must be direct.  That is, there must not be any copying in
 * the map or unmap steps.  Note that performance of direct mappings may
 * be much lower than normal memory.
 */
export const AV_HWFRAME_MAP_DIRECT   = 1 << 3;
 ...
 * @return       Zero on success, negative AVERROR code on failure.
 */
export function av_hwframe_ctx_create_derived(derived_frame_ctx: Out<AVBuffer>,
                                format: AVPixelFormat,
