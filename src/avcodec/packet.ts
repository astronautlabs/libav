 ...
 * @{
 */
export enum AVPacketSideDataType {
    /**
 ...
 */
export interface AVPacketList {
    pkt: AVPacket;
    next: AVPacketList;
}

///< The packet contains a keyframe
export const AV_PKT_FLAG_KEY =     0x0001;

///< The packet content is corrupted
export const AV_PKT_FLAG_CORRUPT = 0x0002;
 ...
 * after decoding.
 **/
export const AV_PKT_FLAG_DISCARD =   0x0004;
/**
 ...
 */
export const AV_PKT_FLAG_TRUSTED =   0x0008;
/**
 ...
 * @see av_new_packet
 */
export function av_packet_alloc(): AVPacket { throw new Error('NotImplemented'); };
